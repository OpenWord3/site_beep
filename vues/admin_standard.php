                  ...
                  <tr>
                    ...
                    <td>
						<select value="begin_jour" name="begin_jour" id="begin_jour">
							<option value="mon" <?php if($jour[0] = "mon"){ echo'selected="selected"'; } ?>>Lundi</option>
							<option value="tue" <?php if($jour[0] = "tue"){ echo'selected="selected"'; } ?>>Mardi</option>
							<option value="wed" <?php if($jour[0] = "wed"){ echo'selected="selected"'; } ?>>Mercredi</option>
							<option value="thu" <?php if($jour[0] = "thu"){ echo'selected="selected"'; } ?>>Jeudi</option>
							<option value="fri" <?php if($jour[0] = "fri"){ echo'selected="selected"'; } ?>>Vendredi</option>
							<option value="sat" <?php if($jour[0] = "sat"){ echo'selected="selected"'; } ?>>Samedi</option>
							<option value="sun" <?php if($jour[0] = "sun"){ echo'selected="selected"'; } ?>>Dimanche</option>
						</select>
					</td>
                  </tr>
                  <tr>
                    ...
                    <td>
						<select  value="end_jour" name="end_jour" id="end_jour">
							<option value="mon" <?php if($jour[1] = "mon"){ echo'selected="selected"'; } ?>>Lundi</option>
							<option value="tue" <?php if($jour[1] = "tue"){ echo'selected="selected"'; } ?>>Mardi</option>
							<option value="wed" <?php if($jour[1] = "wed"){ echo'selected="selected"'; } ?>>Mercredi</option>
							<option value="thu" <?php if($jour[1] = "thu"){ echo'selected="selected"'; } ?>>Jeudi</option>
							<option value="fri" <?php if($jour[1] = "fri"){ echo'selected="selected"'; } ?>>Vendredi</option>
							<option value="sat" <?php if($jour[1] = "sat"){ echo'selected="selected"'; } ?>>Samedi</option>
							<option value="sun" <?php if($jour[1] = "sun"){ echo'selected="selected"'; } ?>>Dimanche</option>
						</select>
					</td>
                  </tr>
